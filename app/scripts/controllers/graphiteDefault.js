...
// No Storage enabled for this...this will be what a fresh dashboard will look like for new team
angular.module('app')
  .controller('GraphiteDefaultCtrl', function ($scope, $window, $interval, nvd3ChartDefAttrs, WidgetDefaults) {
